...
const Login = () => {
    ...
    //we will pass login fn to handleSubmit fn of useFOrm hook it it will call login with data(json)
                        ...
                        <Input
                            ...
                            {...register('email', {
                                ...
                                validate: {
                                    ...
                                    //above is reg expression to get this got to RegExr.com website
                                }
                            })}
                        />
                        <Input
